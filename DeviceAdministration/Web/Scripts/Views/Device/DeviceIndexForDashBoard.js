IoTApp.createModule('IoTApp.DeviceIndex', function () {
    ...
    var init = function (deviceDetails) {
        ...
        self.deviceGridContainer = $(".grid_container_DeviceIndex");
    ...
    var _initializeDatatable = function() {
        ...
        var onTableRowClicked = function () {
            ...
            $('#deviceSelection').val(data);
            IoTApp.Dashboard.DashboardDevicePane.updateDeviceId(data);
            IoTApp.Helpers.DeviceIdState.saveDeviceIdToCookie(data);

            //var viewData = {
            //    Latitude: this.cells[9].innerHTML,
            //    Longitude: this.cells[10].innerHTML
            //};
            //IoTApp.MapPane.setDeviceLocationData(
            //       this.cells[9].innerHTML,
            //       this.cells[10].innerHTML,
            //       this.cells[9].innerHTML+1,
            //       this.cells[10].innerHTML+1,
            //       viewData
            //   );
            //IoTApp.MapPane.setView();
        }
        ...
        var _setGridContainerScrollPositionIfRowIsSelected = function() {
            if ($("tbody .selected").length > 0) {
                $('.grid_container_DeviceIndex')[0].scrollTop = $("tbody .selected").offset().top - $('.grid_container_DeviceIndex').offset().top - 50;
            }
        }
    }
    ...
    function fixHeights() {
        ...
        $(".height_fixed_DeviceIndex").height(fixedHeightVal);
    ...
    var setGridWidth = function () {
        var gridContainer = $(".grid_container_DeviceIndex");
