    ...
    function initTelemetryHistory() {
        ...
        var createDataView = function createDataView(data) {
            ...
            graphMetadata = {
                columns: [
                    ...
                    {
                        displayName: 'ExternalTemperature',
                        isMeasure: true,
                        format: "0.0",
                        queryName: 'externalTemperature',
                        type: powerbi.ValueType.fromDescriptor({ numeric: true })
                    },
                    {
                        displayName: 'PM2.5',
            ...
            columns = [
                ...
                {
                    source: graphMetadata.columns[3],
                    values: graphData.externalTemperatures
                },
                {
                    source: graphMetadata.columns[4],
                    values: graphData.PM25s
                },
                {
                    source: graphMetadata.columns[5],
                    values: graphData.PM10s
                }
            ];
        ...
        var produceGraphData = function produceGraphData(data) {
            ...
            for (i = 0 ; i < data.length ; ++i) {
                ...
                results.externalTemperatures.push(item.externalTemperature);
                results.PM25s.push(item.pM25);
                results.PM10s.push(item.pM10);
