...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.DeviceAdmin.Infrastructure.BusinessLogic
{
    public class ActionMappingLogic : IActionMappingLogic
    {
        ...
        private const string _ruleOutputAlarmPowerOff = "AlarmPowerOff";
        private const string _ruleOutputAlarmPowerOn = "AlarmPowerOn";

        private List<string> _availableRuleOutputs = new List<string>() 
        {
            _ruleOutputAlarmTemp,
            _ruleOutputAlarmHumidity,
            _ruleOutputAlarmPowerOff,
            _ruleOutputAlarmPowerOn
        };
        ...
        public async Task<bool> InitializeDataIfNecessaryAsync()
        {
            ...
            {
                RuleOutput = _ruleOutputAlarmPowerOff,
                ActionId = "Power Off"
            };
            ...
            {
                RuleOutput = _ruleOutputAlarmPowerOn,
                ActionId = "Power On"
            };
