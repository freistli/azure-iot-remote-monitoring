...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.DeviceAdmin.Infrastructure.Repository
{
    ...
    public class DeviceTelemetryRepository : IDeviceTelemetryRepository
    {
        ...
        private readonly string _telemetrySummaryPrefix, _telemetrySummaryPM25Prefix;
        ...
        public DeviceTelemetryRepository(IConfigurationProvider configProvider)
        {
            ...
            _telemetrySummaryPM25Prefix = configProvider.GetConfigurationSettingValue("TelemetrySummaryPM25Prefix");
        }
        ...
        private async static Task<List<DeviceTelemetryModel>> LoadBlobTelemetryModelsAsync(CloudBlockBlob blob)
        {
            ...
            try
            {
                ...
                foreach (StrDict strdict in strdicts)
                {
                    ...
                    if (strdict.TryGetValue("pm25", out str) &&
                       double.TryParse(
                           str,
                           NumberStyles.Float,
                           CultureInfo.InvariantCulture,
                    ...
                    if (strdict.TryGetValue("pm10", out str) &&
                       double.TryParse(
                           str,
                           NumberStyles.Float,
                           CultureInfo.InvariantCulture,
            ...
            CloudBlockBlob blob)
        {
            ...
            try
            {
                ...
                foreach (StrDict strdict in strdicts)
                {
                    ...
                    if (strdict.TryGetValue("averagepm25", out str) &&
                       double.TryParse(
                            str,
                            NumberStyles.Float,
                            CultureInfo.InvariantCulture,
                    ...
                    if (strdict.TryGetValue("maxpm25", out str) &&
                       double.TryParse(
                            str,
                            NumberStyles.Float,
                            CultureInfo.InvariantCulture,
                    ...
                    if (strdict.TryGetValue("minimumpm25", out str) &&
                      double.TryParse(
                           str,
                           NumberStyles.Float,
                           CultureInfo.InvariantCulture,
